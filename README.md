...
## 🚀 Eco Mode & Ultra Eco Mode (Windows)

Spotube propose désormais deux niveaux d’optimisation pour Windows :

### 🌱 Mode Éco
- Réduit la consommation CPU/GPU/RAM en limitant le framerate à 30 FPS et en simplifiant les animations.
- Les effets visuels lourds sont désactivés ou allégés.
- Idéal pour une écoute longue durée ou sur des configurations modestes.

### 🦾 Mode Ultra Éco
- Lorsque Spotube n’est plus en premier plan (minimisé ou en arrière-plan), l’interface principale se ferme automatiquement : seul le mini-player (ou l’icône de la barre système) reste actif.
- Les téléchargements d’images, pochettes et données lourdes sont suspendus tant que l’UI est inactive.
- La réouverture de la fenêtre est automatique dès que l’utilisateur revient sur Spotube.
- Ce mode maximise l’autonomie et la discrétion, idéal pour écouter de la musique tout en travaillant ou en jouant.

### 🤖 Fonctionnement automatique
- **Activation** : Rendez-vous dans **Paramètres > Apparence** et activez le Mode Éco. Le Mode Ultra Éco s’active automatiquement lorsque l’app passe en arrière-plan.
- **Aucune action manuelle requise** : tout est géré par Spotube.

### 💡 Conseils d’utilisation
- Utilisez le Mode Éco pour économiser la batterie ou les ressources.
- Laissez Spotube tourner en arrière-plan : il ne consommera presque rien tant que vous n’êtes pas sur l’interface.
- Si vous souhaitez garder un contrôle minimal, utilisez l’icône de la barre système (tray) ou le mini-player.

### 🖥️ Version Windows prête à l’emploi
- La version `.exe` générée intègre toutes ces optimisations.
- **Aucune installation de Flutter requise** pour utiliser Spotube Optimisé : téléchargez, installez, profitez !

### ❓ FAQ
- **Dois-je installer Flutter pour utiliser Spotube ?**
  - Non, il suffit de télécharger la version Windows depuis la page [Releases](https://github.com/KRTirtho/spotube/releases).
- **Puis-je contribuer ou modifier Spotube ?**
  - Oui, dans ce cas il faudra installer Flutter (voir documentation officielle).
- **Le Mode Éco fonctionne-t-il sur Mac/Linux ?**
  - Il est principalement optimisé pour Windows, mais certaines optimisations sont actives sur toutes les plateformes.

---

Pour toute question ou suggestion d’optimisation, ouvrez une issue ou contactez le mainteneur ! 🚀
