...
class UserPreferencesNotifier extends Notifier<PreferencesTableData> {
  /// Active ou désactive le mode éco (optimisation CPU/GPU/RAM, animations réduites)
  void setEcoMode(bool value) {
    setData(PreferencesTableCompanion(ecoMode: Value(value)));
  }

  /// Renvoie true si le mode éco est activé
  bool get isEcoMode => state.ecoMode;
